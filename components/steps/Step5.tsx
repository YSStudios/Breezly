...
const Step5: React.FC<Step5Props> = ({ formData, formId }) => {
	...
	const handlePlanSelection = async () => {
		...
		try {
			...
			if (!formResponse.ok) {
				throw new Error(`Form not found or not accessible. Please ensure your form is saved.`);
			}
			...
			toast.error(`Payment processing error: ${error instanceof Error ? error.message : 'Unknown error'}`);
		}
	};
							...
							<div className="flex flex-col space-y-4">
								...
								<div className="overflow-hidden rounded-lg border border-gray-200 transition-all hover:shadow-md">
									<div className="border-b border-gray-200 bg-gradient-to-r from-indigo-50 to-indigo-100 p-4">
										<h3 className="text-lg font-bold text-indigo-700">Standard</h3>
									...
									<div className="p-4">
										<ul className="mb-6 space-y-2">
											<li className="flex items-center">
												<svg className="h-5 w-5 text-green-500" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
												...
												onClick={() => {
													...
													.then(data => {
														if (data.success) {
															...
															alert("Unable to complete purchase simulation. Please try again.");
														}
													})
													.catch(error => {
								...
								{/* <div className="overflow-hidden rounded-lg border-2 border-indigo-500 transition-all hover:shadow-md">
									<div className="border-b border-gray-200 bg-gradient-to-r from-indigo-600 to-indigo-700 p-4">
										<div className="-mt-2 mb-2 text-center">
											<span className="rounded-full bg-indigo-100 px-3 py-1 text-xs font-semibold text-indigo-800">MOST POPULAR</span>
										</div>
